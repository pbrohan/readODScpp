...
extern "C" SEXP _readODScpp_ods_get_sheet_names_(SEXP file, SEXP include_external_data) {
  BEGIN_CPP11
...
static const R_CallMethodDef CallEntries[] = {
    {"_readODScpp_ods_get_sheet_names_", (DL_FUNC) &_readODScpp_ods_get_sheet_names_, 2},
